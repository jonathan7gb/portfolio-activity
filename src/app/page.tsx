  ...
  return (
    <>
      <main className="w-full">
        ...
        <h2 className="text-2xl font-bold text-white mt-16 max-w-6xl mx-auto">Explore my work</h2>
        <div className="flex flex-row gap-4 justify-start items-center w-full max-w-6xl  mx-auto my-12">
